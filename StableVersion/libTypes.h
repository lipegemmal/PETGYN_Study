...
enum class Error {UnknownSimbol,Overflow,NonIdentifier,NonAtribuition,Empty,Repeated,NonDeclared};
...
enum class TokenTypes : int
{
    None = 0,
    Simbol = 3,
    Reserved = 4, //Reserved not used, if reserved token is set to Pre_def_func
    FileEnd = 5,
    Pre_def_func = 11,
    Identifier = 12,
    Const = 13,
